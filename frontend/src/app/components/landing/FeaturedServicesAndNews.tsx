          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-sans">
            {procedures.map((proc) => (
              <div
                ...
                className="flex items-center justify-between p-4 bg-white border border-border-slate rounded-xl hover:border-gov-red hover:shadow-md cursor-pointer transition-all duration-200 group"
              >
                <div>
